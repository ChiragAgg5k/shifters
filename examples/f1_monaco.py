...
f1_drivers = [
    {"name": "Max Verstappen", "max_speed": 95, "acceleration": 18, "cornering_skill": 1.15, "braking_rate": 30},
    {"name": "Lewis Hamilton", "max_speed": 94, "acceleration": 17.5, "cornering_skill": 1.12, "braking_rate": 29},
    {"name": "Charles Leclerc", "max_speed": 93, "acceleration": 17.8, "cornering_skill": 1.10, "braking_rate": 28},
    {"name": "Lando Norris", "max_speed": 92, "acceleration": 17.2, "cornering_skill": 1.08, "braking_rate": 27},
    {"name": "Fernando Alonso", "max_speed": 91, "acceleration": 16.8, "cornering_skill": 1.13, "braking_rate": 28},
    {"name": "Carlos Sainz", "max_speed": 92, "acceleration": 17.0, "cornering_skill": 1.07, "braking_rate": 27},
    {"name": "George Russell", "max_speed": 91, "acceleration": 17.3, "cornering_skill": 1.09, "braking_rate": 28},
    {"name": "Sergio Perez", "max_speed": 90, "acceleration": 17.0, "cornering_skill": 1.05, "braking_rate": 26},
]
...
print(f"Simulated time: {sim.simulation_time:.2f}s ({sim.simulation_time/60:.1f} minutes)")
print("=" * 80)
